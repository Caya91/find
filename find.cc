...
int main(int argc, char *argv[]) {
    ...
    find_args.add_argument("-type")
        ...
        .action([](const std::string& value){
            static const std::vector<std::string> choices = {"a", "d", "f"};
    ...
    if (directory == nullptr) {
        ...
        if (is_regular_file(file_n) && arg_type == (File | All)){
